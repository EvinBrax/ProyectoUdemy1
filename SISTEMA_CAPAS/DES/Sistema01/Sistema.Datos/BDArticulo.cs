...
namespace Sistema.Datos
{
    ...
    {
        //Funciones para poder manipular los datos de la BD referente a la tabla "ARTICULO"
        ...
        public DataTable Listar()
        {
            ...
            try
            {
                //Obtener los registros de la Tabla ARTICULO y pasarlo al DataTable
                ...
                //Se llama al Sp con el fin de consultar la tabla "ARTICULO" de la BD
        ...
        public DataTable Buscar(string Valor)
        {
            ...
            try
            {
                ...
                SqlCon = Conexion.GetInstancia().CrearConexion();
                //Se llama al Sp con el fin de buscar la ARTICULO enviada
        ...
        public string Existe(string Valor)
        {
            ...
            try
            {
                //Logica para inserta un registro en la tabla "ARTICULO" en la BD SQL SERVER
        ...
        public string Actualizar(Articulo Obj)
        {
            ...
            try
            {
                //Logica para actualizar un registro en la tabla "ARTICULO" en la BD SQL SERVER
                SqlCon = Conexion.GetInstancia().CrearConexion();
        ...
        public string Eliminar(int Id)
        {
            ...
            try
            {
                //Logica para eliminar un registro en la tabla "ARTICULO" en la BD SQL SERVER
                SqlCon = Conexion.GetInstancia().CrearConexion();
        ...
        public string Activar(int Id)
        {
            ...
            try
            {
                //Logica para activar un registro en la tabla "ARTICULO" en la BD SQL SERVER
                SqlCon = Conexion.GetInstancia().CrearConexion();
        ...
        public string Desactivar(int Id)
        {
            ...
            try
            {
                //Logica para desactivar un registro en la tabla "ARTICULO" en la BD SQL SERVER
                SqlCon = Conexion.GetInstancia().CrearConexion();
